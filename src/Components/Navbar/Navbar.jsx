        ...
        <div className="navbar bg-base-100 shadow-sm">
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    <li><a className="text-1xl font-semibold bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent underline underline-offset-4 decoration-[#632EE3]">Home</a></li>
                    <li><a>App</a></li>
                    <li><a>Installattion</a></li>
                </ul>
            </div>
